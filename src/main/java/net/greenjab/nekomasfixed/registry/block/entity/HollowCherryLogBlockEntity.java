...
public class HollowCherryLogBlockEntity extends AbstractHollowLogBlockEntity {

    private BlockState storedBlock = Blocks.AIR.getDefaultState();

    public HollowCherryLogBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntityTypeRegistry.HOLLOW_CHERRY_LOG_BLOCK_ENTITY_TYPE, pos, state);
    }
